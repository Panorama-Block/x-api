import { AvaxTweet, HederaTweet, Tweet, ZicoTweet } from "../model/tweet"
...
export const getHederaTweets = async (options: PaginationOptions = { page: 1, limit: 20 }) => {
  try {
    const skip = (options.page - 1) * options.limit;
